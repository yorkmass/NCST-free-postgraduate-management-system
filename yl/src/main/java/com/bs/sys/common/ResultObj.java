...
public class ResultObj {
    ...
    public static final ResultObj CAL_SUCCESS = new ResultObj(Constast.OK,"计算成功");
    public static final ResultObj CAL_NOPERMISSION = new ResultObj(Constast.ERROR,"无权限");
    public static final ResultObj CAL_ERROR = new ResultObj(Constast.ERROR,"计算失败");

    public static final ResultObj REJECT_SUCCESS = new ResultObj(Constast.OK,"驳回成功");
    public static final ResultObj REJECT_ERROR = new ResultObj(Constast.ERROR,"驳回失败");

    public static final ResultObj PASS_SUCCESS = new ResultObj(Constast.OK,"审核成功");
    public static final ResultObj PASS_ERROR = new ResultObj(Constast.ERROR,"审核失败");
